...
public class ListSubwStationWithLocalization extends ListSubwStation {
    private Locale locale;
    public ListSubwStationWithLocalization(String name, int openingYear, Locale locale) {
    ...
    private static ListSubwStationWithLocalization createSubwayStation(Locale locale) {
        ResourceBundle bundle = Add.getLocalizationBundle(locale);
        ListSubwStationWithLocalization station = new ListSubwStationWithLocalization(bundle.getString("subwayStation.name"),1975, locale);

        HourWithDates[] hours = new HourWithDates[]{
                new HourWithDates(1234, "comment1",Add.getCurrentDateTimeMinusDays(30),locale),
                new HourWithDates(213, "comment2", Add.getCurrentDateTimeMinusDays(51), locale),
                new HourWithDates(800, "comment3", Add.getCurrentDateTimeMinusDays(0), locale),
                new HourWithDates(1500, "comment4", Add.getCurrentDateTimeMinusDays(69),locale),
                new HourWithDates(1000, "comment5", Add.getCurrentDateTimeMinusDays(4), locale)
        };
    ...
    public void test() {
        ...
        System.out.printf("%n%s ==> %d",bundle.getString("label.totalPassengers"), getTotalPassengersNumber());
        System.out.printf("%n%s ==> %s",bundle.getString("label.hourWithMaxWordNumberInComment"),getHourWithMaxWordNumberInComment());
        System.out.printf("%n%s ==> %s",bundle.getString("label.hourWithLeastPassengersNumber"),getHourWithLeastPassengersNumber());
        NumberFormat numberFormat = NumberFormat.getInstance(locale);
        System.out.printf("%n%s ==> %s",bundle.getString("label.avgPassengers"),numberFormat.format(getAvgPassengers()));
        System.out.printf("%n%s ==> %d %s",bundle.getString("label.shortestPeriod"),getShortestPeriod().getDays(),bundle.getString("label.days"));
        String comment = "com";
        System.out.printf("%n%s '%s': %n%s",bundle.getString("label.findHoursByComment"),comment, toStringHours(findHoursByComment(comment)));
    ...
    public static void main(String[] args) {
        ...
        ListSubwStationWithLocalization station =
                ListSubwStationWithLocalization.createSubwayStation(loc);
        System.out.println("\n()()()()()()()()()--- locale: " + loc + "---()()()()()()()()()\n");
        station.test();
        loc = new Locale("uk");
        System.out.println("\n()()()()()()()()()--- locale: " + loc + "---()()()()()()()()()\n");
        station = ListSubwStationWithLocalization.createSubwayStation(loc);
        station.test();
    }
}
